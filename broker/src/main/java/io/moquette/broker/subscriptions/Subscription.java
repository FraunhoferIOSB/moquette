...
public final class Subscription implements Serializable, Comparable<Subscription> {
    ...
    /**
     * The topic as set by the client.
     */
    final Topic topicFilterClient;

    /**
     * The topic as used internally. Initially the same as the client topic, but
    ...
    public Subscription(String clientId, Topic topicFilter, MqttSubscriptionOption options) {
        this(clientId, topicFilter, options, EMPTY_SHARENAME, null);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(clientId, shareName, topicFilterClient);
    }
